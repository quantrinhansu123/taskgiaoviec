 ...
 * - Điện thoại thật: full màn, không khung iOS
 * - Máy tính hoặc /desktop: sidebar + lưới rộng
 * - Dev trên PC mở /san-pham: khung iOS (tùy chọn preview)
 */
export function useEffectiveLayout(pathname) {
  ...
  const effectiveLayout = urlLayout === 'desktop' || isWide ? 'desktop' : 'mobile';
